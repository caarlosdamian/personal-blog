...
export const SectionWithList = <T,>({
  ...
  return (
    <section className="flex flex-col py-8 border-t-[1px] border-t-neutral-200 dark:border-t-neutral-700  pb-8 lg:pb-12">
      <SectionTitle title={title} />
      {description && <h3 className='text-lg text-light-600_dark-400 mt-2 mb-6'>{description}</h3>}
      <List
